...
gulp.task('copyjs',function(){
	gulp.src('script/thirdplugins/*.js')//执行的文件的路径
	.pipe(gulp.dest('../dist/script/thirdplugins/'));//输出的路径
});



gulp.task('watchcopyhtml',function(){
	gulp.watch('../src/*.html',function(){//监听js下面的所有的js文件
		gulp.run('uglifycss');//执行copy任务。
	});
})
//11.雪碧图制作插件
